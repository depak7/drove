...
const api = {
  ...
  decline: (id2) => post(`/api/features/${id2}/decline`),
  pivot: (id2, intent) => post(`/api/features/${id2}/pivot`, { intent })
};
function useStream(onStatus) {
  const [connected, setConnected] = reactExports.useState(false);
  const [logs, setLogs] = reactExports.useState({});
  const [stages, setStages] = reactExports.useState({});
  const statusRef = reactExports.useRef(onStatus);
  ...
  reactExports.useEffect(() => {
    ...
    source.onmessage = (message) => {
      ...
      const { feature_id: id2, kind } = event;
      if (kind === "status" || kind === "done" || kind === "plan") statusRef.current?.(event);
      if (kind === "stage") setStages((prev) => ({ ...prev, [id2]: event.stage }));
      if (kind === "done") setStages((prev) => ({ ...prev, [id2]: event.status }));
      const line = describe(event);
      if (!line) return;
      setLogs((prev) => {
        const next = [...prev[id2] ?? [], line];
        return { ...prev, [id2]: next.slice(-400) };
      });
    };
    return () => source.close();
  }, []);
...
function describe(event) {
  switch (event.kind) {
    ...
    case "rate_limit":
      return event.utilization > 0.8 ? { tone: "warn", text: `rate limit window ${Math.round(event.utilization * 100)}% used` } : null;
    case "error":
...
const progress = (status) => AT[status] ?? { at: 0, state: "stopped" };
const LABEL = {
...
const label = (status) => LABEL[status] ?? ["neutral", String(status).replace(/_/g, " ")];
const STAGE_COLOR = {
  plan: "var(--st-plan)",
...
function Plan({ plan }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    plan.steps?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "steps", children: plan.steps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "step", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "n", children: i + 1 }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: step.title }),
          step.files?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "files mono", children: step.files.join("  ·  ") })
        ] })
      ] }, i)) })
    ] }),
    plan.acceptance_criteria?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "eyebrow", children: "Done when" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: plan.acceptance_criteria.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: c }, i)) })
    ] }),
...
function Gate({ busy, onApprove, onDecline, onRevise }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gatebar", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "eyebrow", children: "Your call" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grow" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "ghost danger", disabled: busy, onClick: onDecline, children: "Discard" }),
      open ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: busy || !feedback.trim(), onClick: send, children: "Send feedback" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: busy, onClick: () => setOpen(true), children: "Revise…" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "primary", disabled: busy, onClick: onApprove, children: "Approve & run" })
    ] })
  ] });
}
function Log({ lines, connected }) {
  ...
  const onScroll = () => {
    ...
    if (!el2) return;
    pinned.current = el2.scrollHeight - el2.scrollTop - el2.clientHeight < 40;
  };
  reactExports.useEffect(() => {
...
function Diff({ text, repos }) {
  if (!text) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "var(--text-3)" }, children: "No changes yet." }) });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    repos?.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "banner warn", style: { borderRadius: "var(--radius)", marginBottom: 12, border: "1px solid #E8B33940" }, children: [
      "This change spans ",
      repos.length,
      " repositories. Their branches must be merged together — landing one without the others breaks things."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "block diff", children: text.split("\n").map((line, i) => {
      if (line.startsWith("===== repo:")) {
        return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "repo", children: line.replace(/=====/g, "").trim() }, i);
      }
      const cls = line.startsWith("+++") || line.startsWith("---") || line.startsWith("diff ") ? "meta" : line.startsWith("@@") ? "hunk" : line.startsWith("+") ? "add" : line.startsWith("-") ? "del" : "";
...
function Pivot({ busy, onPivot }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "eyebrow", children: "Change direction" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "textarea",
      {
        rows: 2,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 10 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: busy || !intent.trim(), onClick: send, children: "Plan the pivot" }) })
  ] });
}
function Pulse() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `pulse ${tone}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dot" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "label", children: waiting > 0 ? `${waiting} plan${waiting === 1 ? "" : "s"} need you` : running > 0 ? `${running} run${running === 1 ? "" : "s"} in flight` : "idle" }),
    waiting > 0 && running > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "sub", children: [
      "· ",
      running,
      " running"
    ] })
...
createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: isPulse ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pulse, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) })
);
